            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="prezime" class="col-md-4 col-form-label text-md-end">{{ __('Prezime') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('Broj telefona') }}</label>

                            <div class="col-md-6">
                                <input id="brojtelefona" type="text" class="form-control @error('brojtelefona') is-invalid @enderror" name="brojtelefona" value="{{ old('brojtelefona') }}" required autocomplete="brojtelefona" autofocus>
