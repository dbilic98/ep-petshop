    ...
    <div class="container mt-2">
        <div class="row">
            <form class="mx-auto border-0" method="GET"
                  action="{{route('p_hrana',[$min_cijena ?? '',$max_cijena ?? ''])}}">
                                    ...
                                    @if($dogProduct->subcategories->naziv=='Hrana')
                                        <div class="col-md-3 mb-3">
                                            <div class="card product_data p-3">
                                                <img src="{{asset('assets/uploads/products/'.$dogProduct->slika)}}"
                                                     class="card-img mx-auto" alt="..."
                                                ...
                                                <div class="row mt-2">
                                                    <div class="col-md-9">
                                                        <input type="hidden" value="{{$dogProduct->id}}"
                                                               class="prod_id">
                                                        <label for="kolicina">Kolicina</label>
                                                        <div class="input-group text-center mb-3" style="width: 130px;">
                                                            <button class="input-group-text decrement-btn">-</button>
                                                            <input type="text" name="kolicina"
                                                                   class="form-control kolicina-input text-center"
                                                                   value="1">
                                                    ...
                                                    @if($dogProduct->kolicina > 0)
                                                        <button type="button"
                                                                class="btn btn-primary me-3 addToCartBtn float-start">
                                                            Dodaj u
                                                            košaricu <i class="fa fa-shopping-cart"></i></button>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
